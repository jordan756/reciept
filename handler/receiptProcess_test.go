...
func TestProcessReceiptsRepeatFailure(t *testing.T) {
	recipt := structs.Receipt{
		Retailer:     "Target",
		PurchaseDate: "2022-01-01",
		PurchaseTime: "13:01",
...
func TestProcessReceiptsRepeatFailure2(t *testing.T) {
	recipt := structs.Receipt{
		Retailer:     "Target",
		PurchaseDate: "2022-01-01",
		PurchaseTime: "13:01",
		Total:        "35.35",
		Items: []structs.Item{
			{ShortDescription: "Mountain Dew 12PK", Price: "6.3349"},
			{ShortDescription: "Emils Cheese Pizza", Price: "12.4425"},
			{ShortDescription: "Knorr Creamy Chicken", Price: "1.5526"},
			{ShortDescription: "Doritos Nacho Cheese", Price: "3.6635"},
			{ShortDescription: "   Klarbrunn 12-PK 12 FL OZ  ", Price: "12.0235353253260"},
		},
	}
	jsonBody, err := json.Marshal(recipt)
	if err != nil {
